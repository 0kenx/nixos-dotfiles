# Optimize man cache generation to improve rebuild speed
# Ref: https://github.com/MidAutumnMoon/TaysiTsuki/blob/6a4708cb2c4b46c97fd1ee98fd8f2b77df13bfe6/nixos/documentation/default.nix
{ pkgs, config, lib, ... }:
...
lib.mkMerge [
  ...
  in lib.mkIf (cfg.enable) {
    ...
    systemd.services."man-db" = {
      ...
      # Here, it is essentially implementing content-addressed man-db cache.
