...
let
  ...
  getConfigPath = path: default:
    let
      splitPath = lib.splitString "." path;
      result = lib.getAttrFromPath splitPath config;
    in
      if result == null then default else result;
      
  # Try to safely get config values or fall back to defaults
  primary = getConfigPath "nixosConfig.system.nixos-dotfiles.host.displays.primary" "eDP-1";
  secondary = getConfigPath "nixosConfig.system.nixos-dotfiles.host.displays.secondary" null;
  tertiary = getConfigPath "nixosConfig.system.nixos-dotfiles.host.displays.tertiary" null;
  
  # Scale factors with defaults
  primaryScale = toString (getConfigPath "nixosConfig.system.nixos-dotfiles.host.displays.primaryScale" 1.0);
  secondaryScale = toString (getConfigPath "nixosConfig.system.nixos-dotfiles.host.displays.secondaryScale" 1.0);
  tertiaryScale = toString (getConfigPath "nixosConfig.system.nixos-dotfiles.host.displays.tertiaryScale" 1.0);
  ...
  secondaryRotate = getConfigPath "nixosConfig.system.nixos-dotfiles.host.displays.secondaryRotate" null;
  tertiaryRotate = getConfigPath "nixosConfig.system.nixos-dotfiles.host.displays.tertiaryRotate" null;
  ...
  secondaryPos = getConfigPath "nixosConfig.system.nixos-dotfiles.host.displays.secondaryPosition" "auto-right";
  tertiaryPos = getConfigPath "nixosConfig.system.nixos-dotfiles.host.displays.tertiaryPosition" "auto-right";
