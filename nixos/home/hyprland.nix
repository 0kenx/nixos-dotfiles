  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "$mainMod ALT, 1, workspace, 21"
        "$mainMod ALT, 2, workspace, 22"
        "$mainMod ALT, 3, workspace, 23"
        "$mainMod ALT, 4, workspace, 24"
        "$mainMod ALT, 5, workspace, 25"
        "$mainMod ALT, 6, workspace, 26"
        "$mainMod ALT, 7, workspace, 27"
        "$mainMod ALT, 8, workspace, 28"
        "$mainMod ALT, 9, workspace, 29"
        "$mainMod ALT, 0, workspace, 30"
