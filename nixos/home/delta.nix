{inputs, username, host, lib, pkgs, ...}: {
  # Instead of using the git.delta module directly, we'll use Git's extraConfig
  # to configure Delta and avoid conflicts with multiple pager definitions
  ...
  programs.git.settings = {
    ...
    # Set interactive diffFilter
    interactive.diffFilter = "delta --color-only";

    # Delta configuration and themes
    ...
    delta = {
      "catppuccin-latte" = {
        ...
        map-styles = "bold purple => syntax \"#d5c3f4\", bold blue => syntax \"#bbcff5\", bold cyan => syntax \"#b4def1\", bold yellow => syntax \"#ebd9bf\"";
